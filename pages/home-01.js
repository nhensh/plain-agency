        ...
        <div className="wrapper position-relative">
          <main className="pv-page-wrapper">
                ...
                <div className="container">
                  <div className="row align-items-center">
                    ...
                    <div className="col-lg-9 col-md-6 col-sm-6 col-12 header-right">
                      <div className="mainmenu-wrapepr justify-content-sm-end justify-content-start mt_mobile--10">
                        <nav className="mainmenu-nav d-none d-lg-block">
                          <ul className="mainmenu">
                            <li>
                              <a className="smoth-animation" href="#demos">
                                Template
                              </a>
                            </li>
                            <li>
                              <a className="smoth-animation" href="#feature">
                                Features
                              </a>
                            </li>
                            <li>
                              <a className="smoth-animation" href="#chooseUs">
                                Why Us
                              </a>
                            </li>
                          </ul>
            ...
            <div className="pv-banner-wrapper theme-gradient-4">
              <div
                className="pv-banner-area paralax-area"
                  ...
                  <div className="row">
                    <div className="col-lg-7">
                      <div className="inner pt--200 pt_sm--0 pt_md--0">
                        <h1 className="title">
                          Creative Agency, Corporate and Portfolio React
                          Template
                        </h1>
                        <a
                          className="scroll-down-btn smoth-animation"
                          href="#demos"
                        >
            ...
            <div
              className="page-demo-area ax-section-gap theme-gradient-9 position-relative"
              id="demos"
            >
              <div className="container wrapper">
                <div className="row align-items-center row--40">
                  <div className="col-xl-6 col-lg-6 col-md-6 col-12">
                    <div className="pv-section-title">
                      <h2>
                        Our Template Are Just <br /> Ready to Use
                      </h2>
                    </div>
                  </div>
                  <div className="col-xl-6 col-lg-6 col-md-6 col-12 mt_sm--20">
                    <div className="pv-subtitle-title">
                      <p>
                        You will love all of the features in our template.{" "}
            ...
            <div
              className="pv-feature-area ax-section-gap theme-gradient-4 position-relative"
              id="feature"
            >
              <div className="container wrapper">
                <div className="row align-items-center">
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Our Template is Perfect for all devices. It is
                              made by React Structure. React JS was designed to
                              provide high performance in mind.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              ...
                              We made Plain-Agency using functional components.
                              You can reuse any components
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Sass is more stable, powerful, and elegant because
                              it is an extension of CSS. So, it is easy for
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              All the pages of this template are responsive. We
                              used the Bootstrap framework to build the website.
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              All the pages are created based on real content
                              that you will need to run your business. Change
                              image and text and you’re good to go!
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Website speed is very important. Hence we’ve
                              created Abstrak in a way that your website will
                              load fast, and you will get better performance.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              This template comes with licensed premium quality
                              icons from FontAwesome. All the icons are font
                              based and ready to match the quality of any HQ
                              screen.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              A vast collection of Google fonts are integrated
                              with the template. You can use any of them that
                              goes with your branding.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="pv-feature paralax-image">
                        <div className="inner">
                          ...
                          <div className="content">
                            ...
                            <p>
                              Purchase our template only once and get lifetime
                              updates. We keep updating our products to stay up
            ...
            <div
              className="choose-us-area bg-color-extra11 position-relative"
              id="chooseUs"
            >
                ...
                <div className="container wrapper">
                  <div className="row">
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-12 mt_sm--20">
                      <div className="pv-subtitle-title">
                        <p>
                          Every template is built with such efforts <br /> that
                          they are ready to meet all of our
                        ...
                        <div className="pv-choose-us paralax-image">
                          <div className="inner">
                            ...
                            <div className="description">
                              <p>
                                We build Templates that are rich in content and
                                have a good user interface to deliver a premium
                      ...
                      >
                        <div className="pv-choose-us bg-color-2 paralax-image">
                          <div className="inner">
                            ...
                            <div className="description">
                              <p>
                                Our Template is SEO and SMM-friendly that aligns
                                with your digital marketing strategies to bring
                      ...
                      >
                        <div className="pv-choose-us bg-color-3 paralax-image">
                          <div className="inner">
                            ...
                            <div className="description">
                              <p>
                                The coding structure of our items is organized
                                so other developers can easily recognize the
                                pattern and make updates as needed.
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="row mt--40 mb_md--5 md_sm--5">
                    <div className="col-lg-4 col-md-6 col-12 offset-lg-2 mt--85 mt_lg--40 mt_md--5 mt_sm--5">
                      <Tilt
                        tiltMaxAngleX={7}
                        tiltMaxAngleY={7}
                        className="h-100"
                      >
                        <div className="pv-feature paralax-image online-documentation">
                          <div className="inner">
                            ...
                            <div className="content">
                              <h4 className="title primary-color">
                              ...
                              <a
                                target="_blank"
                                rel="noreferrer"
                                href="https://new.axilthemes.com/docs/Plain-Agency-react/"
                      ...
                      >
                        <div className="pv-feature paralax-image datecated-support">
                          <div className="inner">
                            ...
                            <div className="content">
                              <h4 className="title extra08-color">
                                Dedicated Support
                              </h4>
                              <p>
                                Our response time is 24-hour in regular business
                                days.
                              </p>
                              <a
                                target="_blank"
                          ...
                          <ul className="liststyle d-flex quick-links">
                            ...
                            <li>
                              <a
                                target="_blank"
                                rel="noreferrer"
                                href="https://new.axilthemes.com/demo/react/Plain-Agency/privacy-policy"
                              >
                                PRIVACY POLICY
                              </a>
                            </li>
