...
const Heads = () => {
    return (
        <Head>
            ...
            <meta property="og:title" content="Plain Agency | Web and Mobile application developing agency" />
            ...
            <title>Plain Agency | Web and Mobile application developing agency</title>
